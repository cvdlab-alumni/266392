...
var inserisciAbitazioni = function (xmin,xmax,ymin,ymax) {
	...
	for(i=0; i<coordinate.length; i++) {
		...
		if(coordZ>=livelloDelMare && coordX>=xmin && coordX<=xmax && coordY>=ymin && coordY<=ymax && casual1>0.25 && casual2>0.25) {
...
/* Generazione strada collegamento tra città */
var streetA = TRANSLATE([0,1,2])([20,-40,0])(CUBOID([2,25,0.2]));
var streetB = TRANSLATE([0,1,2])([20,-15,0])(CUBOID([27,2,0.2]));

var strade = STRUCT([streetA,streetB]);
